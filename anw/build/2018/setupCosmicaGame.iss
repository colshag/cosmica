...
#define MyAppVersion "0.14.3.0"
#define MyAppName "Cosmica 0.14.3.0"
...
[Icons]
Name: "{userdesktop}\Cosmica {#myAppVersion} Single Player"; Filename: "{app}\Client\singleplayer.bat"; \
    IconFilename: "{app}\Client\logo.ico"; Tasks: desktopicon
Name: "{userdesktop}\Cosmica {#myAppVersion} Join Game"; Filename: "{app}\Client\startclient.bat"; \
    IconFilename: "{app}\Client\logo.ico"; Tasks: desktopicon
Name: "{userdesktop}\Cosmica {#myAppVersion} Host Game"; Filename: "{app}\Client\startserver.bat"; \
    IconFilename: "{app}\Client\logo.ico"; Tasks: desktopicon
